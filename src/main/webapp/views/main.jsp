...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        <ul>
            <li>
                <a href="ServletContainer?menu=member&action=Listar" target="myframe" id="btn-socios"><span class="las la-handshake"></span>
                    <span>Socios</span></a>
            </li>
            <li>
                <a href="ServletContainer?menu=employee&action=Listar" target="myframe" id="btn-empleados"><span class="fas fa-address-card"></span>
                    <span>Empleados</span></a>
            </li>
            <li>
                <a href="ServletContainer?menu=credit&action=Listar" target="myframe" id="btn-creditos"><span class="fas fa-th-list"></span>
                    <span>Créditos</span></a>
            </li>
            <li>
                <a href="ServletContainer?menu=payment&action=Listar" target="myframe" id="btn-abonos"><span class="las la-cash-register"></span>
                    <span>Abonos</span></a>
            </li>
            <li>
                <a href="ServletContainer?menu=loan&action=Listar" target="myframe" id="btn-prestamos"><span class="las la-wallet"></span>
...
<div class="main-topbar">
    ...
    <main>
        <div class="m-4 contenedorjsp" style="height: 900px;" >
